...
//  网易彩票swift
//
//  Created by panyong on 14/12/29.
...
//        var bund = NSBundle.mainBundle().pathForResource("SettingTableViewCell.xib", ofType: "xib", inDirectory: "120")
//        self.tableView.registerNib(bund, forCellReuseIdentifier: "cell");
//        var bund = NSBundle.mainBundle().bundlePath
        }
